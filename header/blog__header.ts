...
type blog__header_props_T = {
	ctx:wide_ctx_T
	class?:string
	a_class?:string
	nav_container_class?:string
	is_open?:boolean
	logo_image_class?:string
}&tag_props_T<HTMLElement>
export function blog__header_<env_T extends relement_env_T>($p:blog__header_props_T, ...children:tag_dom_T[]) {
	let {
		ctx,
		class: _class,
		a_class,
